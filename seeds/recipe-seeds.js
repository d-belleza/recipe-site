...
const recipedata = [
  ...
  },
  {
    ...
    recipe_steps: 'Using a long serrated knife or bread knife slice angel food cake into 3 equal horizontal layers. Place the bottom layer onto a freezer-proof plate., Remove packaging from the ice cream and slice about 1-inch thick. ',
    category: 'Dessert',
    image_url: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F1038642.jpg',
    user_id: 3
  },
  {
   ...
   },
  {
    ...
    recipe_steps: 'Preheat your ovens broiler. Spread a thin layer of butter on each slice of bread. Arrange bread slices in a single layer on a large baking sheet., Place bread under the broiler for 1 to 2 minutes just until lightly toasted. ',
    category: 'Appetizers',
  ...
  },
  {
    ...
    category: 'Breakfast',
    image_url: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F1947544.jpg',
    user_id: 4
  },
  {
    ...
    category: 'Breakfast',
    image_url: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F6187926.jpg',
    user_id: 7
  },
  {
    title: 'Bacon and Date Appetizer',
    ingredients: '1 (8 ounce) package pitted dates, 4 ounces almonds, 1 pound sliced bacon',
    recipe_steps: 'Preheat the broiler., Slit dates. Place one almond inside each date. ',
    category: 'Appetizers',
